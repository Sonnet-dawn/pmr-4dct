...
| 5 | `torch.backends.cudnn.benchmark = True` (upstream default) | Identical configurations varied by **6.2% (SD, of the mean)**, range **17.0% (of the mean)**. Two published-effect conclusions were drawn and later reversed | `--cudnn-benchmark 0` | **yes** |
